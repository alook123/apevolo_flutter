...
class ShellVerticalMenuController extends GetxController {
  ...
  Future<void> onChangeMenu(
    ...
    // final selectMenu = _shellController.menuList
    //     .selectMany<ChildrenMenu?>((e, i) => e.children ?? [])
    //     .where((e) => e != null && e.path == path)
    //     .firstOrDefault();
    shellController.selectMenu.value = menu;
    shellController.selectMenuChildren.value = children;
    shellController.selectIcon.value = icon;
