...
class _AuthorizationProvider implements AuthorizationProvider {
  ...
  @override
  Future<HttpResponse<dynamic>> info() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<HttpResponse<dynamic>> resetEmail(String email) async {
    const _extra = <String, dynamic>{};
